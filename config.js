const topBarCenterText = `robby@9Y4R.com`;
// Menu items
...
const aURL = [
  ...
  ["ff9100", "Refresh", "#", "1"],
  ["0dd1a7", "Help", "#", "1"],
  ["2196F3", "CLUBLOG", "https://clublog.org/livestream/9Z4RG", "1.7"],
  [
    "2196F3",
    "CONTEST",
  ...
  [
    "2196F3",
    "LIGHTNING",
    "https://map.blitzortung.org/#5.35/11.975/-59.726",
    "1",
    "R",
  ],
  ...
  [
    "2196F3",
    "WEATHER",
    "https://openweathermap.org/weathermap?basemap=map&cities=true&layer=temperature&lat=10.511568&lon=-61.389590&zoom=5",
    "1",
    "R",
  ],
  [
    "2196F3",
    "WINDS",
    "https://earth.nullschool.net/#current/wind/surface/level/orthographic=-61.39,10.51,3000",
    "1",
    "R",
  ],
];
...
const aIMG = [
  ...
  [
    "LIGHTNING LOCAL",
    "https://www.blitzortung.org/en/Images/image_b_dr.png",
  ],
  ...
  ["HF PROPAGATION", "https://www.tvcomm.co.uk/g7izu/Autosave/HF_ZERO1_AutoSave.JPG"],
  ["HF PROPAGATION",
